    ...
    <View style={s.root}>
      ...
      <SafeAreaView style={s.safe}>
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          ...
          {/* Mode hero banner */}
          <LinearGradient
            colors={['rgba(34,211,238,0.16)', 'rgba(8,145,178,0.06)']}
            start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}
            style={s.heroBanner}
          >
            <Text style={s.heroEyebrow}>NETWORKING MODE</Text>
            <Text style={s.heroTitle}>🤝 Work the room.</Text>
            <Text style={s.heroBody}>Name the event, load your targets, and let Wingman do the heavy lifting.</Text>
          </LinearGradient>
...
const s = StyleSheet.create({
  ...
  heroEyebrow: { color: '#22d3ee', fontSize: 10, fontWeight: '900', letterSpacing: 1.5 },
